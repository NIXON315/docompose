    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Asixcolar <sup><small><span class="label label-success">v1.0</span></small></sup> </a>
        </div>
...
$u=null;
if(Session::getUID()!=""):
  $u = UserManager::getUserData(Session::getUID());
?>
