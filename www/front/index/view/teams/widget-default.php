...
<br>
		...
		$teams = TeamManager::getTeamsByUserId($_SESSION["user_id"]);
		if(count($teams)>0){
			// si hay usuarios
			?>
			...
			foreach($teams as $team){
				...
				<td style="width:130px;"><a href="index.php?view=editteam&id=<?php echo $team->id;?>" class="btn btn-warning btn-xs">Editar</a> <a href="index.php?view=delteam&id=<?php echo $team->id;?>" class="btn btn-danger btn-xs">Eliminar</a></td>
				</tr>
				<?php
