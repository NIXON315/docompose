...
<a href="./report/assistance-word.php?team_id=<?php echo $_GET["team_id"]; ?>&start_at=<?php echo $_GET["start_at"]; ?>&finish_at=<?php echo $_GET["finish_at"]; ?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-download"></i> Descargar</a>
			Lista
			</div>
