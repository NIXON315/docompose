...
<div class="row">
		<div class="col-md-8">
		<h1>Bienvenido a Asixcolar</h1>
		<p class="lead"><b>Asixcolar</b> es una herramienta para profesores en la cual pueden gestionar sus grupos de clases, llevar el control de asistencia, control de comportamiento y las calificaciones de sus alumnos.</p>
		<div class="row">
		<div class="col-md-6">
		<h3>Alumnos</h3>
